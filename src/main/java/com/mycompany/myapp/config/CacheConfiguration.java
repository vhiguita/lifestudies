...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Countries.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Language.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Rol.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.CountryLocation.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.RolLocation.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.UserRegistration.class.getName(), jcacheConfiguration);
