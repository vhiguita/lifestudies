    ...
    describe('UserRegistration Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-registrations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a UserRegistration', () => {
                service.create(new UserRegistration(null)).subscribe(received => {
            ...
            it('should update a UserRegistration', () => {
                service.update(new UserRegistration(123)).subscribe(received => {
            ...
            it('should return a UserRegistration', () => {
            ...
            it('should return a list of UserRegistration', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new UserRegistration(123)]);
            });
